				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-3"> <div class="md-form form-sm">
							<input placeholder="Date" type="text" id="Date" class="form-control">
						</div></div> 
						<div class="col-md-3"> <div class="md-form form-sm">
					...
					<div class="row">					
						...
						<div class="row">
							...
							<div class="col-md-3"> <div class="md-form form-sm">
							<input placeholder="Duration(Days/Week/Month)" type="text" id="Duration" class="form-control">
							</div></div>
							<div class="col-md-3"> <div class="md-form form-sm">
							<input placeholder="Start from the latest date : (DD/MM/YYYY)" type="text" id="latestdate" class="form-control">
							</div></div> 
